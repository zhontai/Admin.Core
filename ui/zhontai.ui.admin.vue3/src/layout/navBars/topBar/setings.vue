  ...
  <div class="layout-breadcrumb-seting">
    ...
    >
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        <!-- 全局主题 -->
        <el-divider content-position="left">{{ $t('全局主题') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('主题颜色') }}</div>
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('深色模式') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <!-- 顶栏设置 -->
        <el-divider content-position="left">{{ $t('顶栏设置') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('顶栏背景') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('顶栏默认字体颜色') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt10">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('顶栏背景渐变') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <!-- 菜单设置 -->
        <el-divider content-position="left">{{ $t('菜单设置') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单背景') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单默认字体颜色') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单高亮背景色') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单背景渐变') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <!-- 分栏设置 -->
        <el-divider content-position="left" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">{{ $t('分栏设置') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏菜单背景') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏菜单默认字体颜色') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏菜单背景渐变') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏菜单鼠标悬停预加载') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <!-- 界面设置 -->
        <el-divider content-position="left">{{ $t('界面设置') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex" :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单水平折叠') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('菜单手风琴') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('固定 Header') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: getThemeConfig.layout !== 'classic' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('经典布局分割菜单') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启锁屏') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isLockScreen" @change="setLocalThemeConfig"></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt11">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('自动锁屏(s/秒)') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input-number
        ...
        <!-- 界面显示 -->
        <el-divider content-position="left">{{ $t('界面显示') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('侧边栏 Logo') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启面包屑') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启面包屑图标') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isBreadcrumbIcon" @change="setLocalThemeConfig"></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启标签页') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isTagsview" @change="setLocalThemeConfig"></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启标签页图标') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isTagsviewIcon" @change="setLocalThemeConfig"></el-switch>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启标签页缓存') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: state.isMobile ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('开启标签页拖拽') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <!-- 其它设置 -->
        <el-divider content-position="left">{{ $t('其它设置') }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('标签页风格') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('主页面切换动画') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏高亮风格') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15 mb27" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('分栏布局风格') }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <!-- 布局切换 -->
        <el-divider content-position="left">{{ $t('布局切换') }}</el-divider>
        <div class="layout-drawer-content-flex">
          ...
          <div class="layout-drawer-content-item" @click="onSetLayout('defaults')">
            ...
            <div class="layout-tips-warp" :class="{ 'layout-tips-warp-active': getThemeConfig.layout === 'defaults' }">
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t('默认') }}</p>
              </div>
            </div>
          </div>
          <!-- classic 布局 -->
          <div class="layout-drawer-content-item" @click="onSetLayout('classic')">
            ...
            <div class="layout-tips-warp" :class="{ 'layout-tips-warp-active': getThemeConfig.layout === 'classic' }">
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t('经典') }}</p>
              </div>
            </div>
          </div>
          <!-- transverse 布局 -->
          <div class="layout-drawer-content-item" @click="onSetLayout('transverse')">
            ...
            <div class="layout-tips-warp" :class="{ 'layout-tips-warp-active': getThemeConfig.layout === 'transverse' }">
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t('横向') }}</p>
              </div>
            </div>
          </div>
          <!-- columns 布局 -->
          <div class="layout-drawer-content-item" @click="onSetLayout('columns')">
            ...
            <div class="layout-tips-warp" :class="{ 'layout-tips-warp-active': getThemeConfig.layout === 'columns' }">
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t('分栏') }}</p>
              </div>
            </div>
          </div>
        </div>
        <div class="copy-config">
          <el-alert :title="$t('点击下方按钮，复制布局配置去 `src/stores/themeConfig.ts` 中修改。')" type="warning" :closable="false"> </el-alert>
