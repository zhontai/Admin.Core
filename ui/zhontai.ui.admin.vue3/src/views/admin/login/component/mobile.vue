<template>
  <div>
    <el-form ref="formRef" :model="state.ruleForm" size="large" class="login-content-form">
      <div class="login-title">{{ t('手机验证码登录') }}</div>
      <el-form-item
      ...
      <el-form-item class="login-animation2" prop="code" :rules="[{ required: true, message: t('请输入短信验证码'), trigger: ['blur', 'change'] }]">
      ...
      <div class="login-animation4 f12 mt10">
        <el-link underline="never" type="primary" class="f12" @click="onLogin">{{ t('手机密码登录') }}</el-link>
      </div>
