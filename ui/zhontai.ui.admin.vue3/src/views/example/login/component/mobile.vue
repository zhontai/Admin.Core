<template>
  <el-form size="large" class="login-content-form">
    <el-form-item class="login-animation1">
      <el-input text :placeholder="$t('请输入手机号')" v-model="state.ruleForm.userName" clearable autocomplete="off">
        <template #prefix>
    ...
    <el-form-item class="login-animation2">
      ...
      <el-col :span="8">
        <el-button v-waves class="login-content-code">{{ $t('获取验证码') }}</el-button>
      </el-col>
    </el-form-item>
...
<script setup lang="ts" name="example/loginMobile">
