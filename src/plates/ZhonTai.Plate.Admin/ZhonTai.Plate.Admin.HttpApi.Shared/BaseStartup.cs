...
namespace ZhonTai.Plate.Admin.HttpApi.Shared
{
    public abstract class BaseStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            if (_env.IsDevelopment() || _appConfig.Swagger)
            {
                services.AddSwaggerGen(options =>
                {
                    typeof(ApiVersion).GetEnumNames().ToList().ForEach(version =>
                    {
                        ...
                        {
                            Version = version,
                            Title = "ZhonTai.Plate.Admin.Host"
                        });
            ...
            //{
            //    var assembly = Assembly.LoadFrom(Path.Combine(basePath, "ZhonTai.Plate.Admin.Host.dll"));
        ...
        public virtual void Configure(IApplicationBuilder app)
        {
            ...
            if (_env.IsDevelopment() || _appConfig.Swagger)
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    {
                        c.SwaggerEndpoint($"/swagger/{version}/swagger.json", $"ZhonTai.Plate.Admin.Host {version}");
                    });
