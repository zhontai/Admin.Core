using My.Admin.HttpApi.Host.Auth;
using My.Admin.Common.Auth;
using My.Admin.Common.Cache;
using My.Admin.Common.Configs;
using My.Admin.Common.Consts;

//using FluentValidation;
//using FluentValidation.AspNetCore;
using My.Admin.Common.Helpers;
using My.Admin.HttpApi.Host.Db;
using My.Admin.HttpApi.Host.Enums;
using My.Admin.HttpApi.Host.Extensions;
using My.Admin.HttpApi.Host.Filters;
using My.Admin.HttpApi.Host.Logs;
using My.Admin.HttpApi.Host.RegisterModules;
...
namespace My.Admin.HttpApi.Host
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var serviceAssembly = Assembly.Load("My.Admin.Service");
            ...
            if (_env.IsDevelopment() || _appConfig.Swagger)
            {
                services.AddSwaggerGen(options =>
                {
                    ...
                    var xmlPath = Path.Combine(basePath, "My.Admin.HttpApi.Host.xml");
                    options.IncludeXmlComments(xmlPath, true);

                    var xmlCommonPath = Path.Combine(basePath, "My.Admin.Common.xml");
                    options.IncludeXmlComments(xmlCommonPath, true);

                    var xmlModelPath = Path.Combine(basePath, "My.Admin.Domain.xml");
                    options.IncludeXmlComments(xmlModelPath);

                    var xmlServicesPath = Path.Combine(basePath, "My.Admin.Service.xml");
            ...
            //{
            //    var assembly = Assembly.LoadFrom(Path.Combine(basePath, "My.Admin.HttpApi.Host.dll"));
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            if (_env.IsDevelopment() || _appConfig.Swagger)
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    {
                        c.SwaggerEndpoint($"/swagger/{version}/swagger.json", $"My.Admin.HttpApi.Host {version}");
                    });
